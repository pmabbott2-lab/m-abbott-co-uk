        ...
        {bookedAt ? (
          <div className="text-center space-y-4 py-4">
            ...
            <DialogHeader className="text-center">
              ...
              <DialogDescription>
                Case opened for {name}. Confirmed for{" "}
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Book an appointment or send a self-booking link. You are recorded as the introducer
                on the case. Name, email and mobile are required.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="rounded-xl border p-3 space-y-3">
              <div className="space-y-2">
                <Label htmlFor="staff-book-name">Full name</Label>
                <Input id="staff-book-name" value={name} onChange={(e) => setName(e.target.value)} />
              </div>
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="space-y-2">
                  <Label htmlFor="staff-book-email">Email</Label>
                  <Input
                    id="staff-book-email"
                    type="email"
                    value={email}
                ...
                <div className="space-y-2">
                  <Label htmlFor="staff-book-phone">Mobile</Label>
                  <Input
                    id="staff-book-phone"
                    value={phone}
